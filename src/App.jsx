  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/quiz/fact-check-no=4" element={!isMobile ? <QuizStep16 /> : ""}  />
        <Route path="/quiz/step=13" element={!isMobile ? <QuizStep17 /> : ""}  />
        <Route path="/quiz/step=14" element={!isMobile ? <QuizStep18 /> : ""} />
