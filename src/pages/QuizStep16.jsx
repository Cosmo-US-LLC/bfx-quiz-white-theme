    ...
    <div className="quiz-container  min-h-screen overflow-hidden flex flex-col items-center p-4">
      ...
      <div className="flex items-center max-w-[1240px] mx-auto justify-between mt-[4rem] w-[100%]">
       ...
       It has never been easier to earn <br /> real passive income with crypto
          ...
          <p className="text-[16px] font-[400] text-[#000] mb-6 ">For example, people who buy the new $BFX token during the presale earn rewards every time someone trades on BlockchainFX. As $BFX holders, they receive a share of the trading fees without having to trade themselves. <br /><br />
