              ...
              <div className="px-12 pt-4">
                <div className="mb-6">
                  ...
                  <div className="flex justify-between mb-2 text-xs ">
                    <span className="text-[12.2px] font-[400] text-[#9190A3]">
                      Low
                    </span>
                    <span className="text-[12.2px] font-[400] text-[#9190A3]">
                      Intermediate
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm">
                      <p className="text-[#9190A3] font-medium mb-2">
                        Impressive score to succeed in crypto
                      </p>
                      <p className="text-[#9190A3] leading-relaxed">
            ...
            <div className="max-w-[548px]  pt-8 mx-auto text-white rounded-lg overflow-hidden">
              ...
              >
                <p className="text-[16px] text-[#fff] font-[700] leading-relaxed ">
                  Based on your responses, your goal is to build wealth <br />{" "}
                  quickly and generate an additional source of income.
                </p>
                <img src={icons4} alt="" />
              </div>
              <div className="flex items-center justify-between mb-6 space-x-2">
                ...
                >
                  ...
                  <span className="text-[14px] text-[#000] font-[700]">
                    {mainGoal}
                  </span>
                </div>
                <div
              ...
              >
                ...
                <span className=" text-[16px] font-[700] text-[#000]">
                  {goalIncome}
                </span>
              </div>
