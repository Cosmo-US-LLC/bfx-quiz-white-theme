  ...
  const handleNext = () => {
    ...
    return(
      ...
      <div className="relative px-4 mb-6">
        <div className="">
          ...
          className="text-[14.1px] text-[#000] px-2 py-1 rounded  ">Your Results</span>
          <h2 className="text-black mt-4 font-[500] text-[18px] ">Readiness Score</h2>
        </div>
      </div>
   ...
   <div className="mb-6">
          ...
          <div className="relative mb-2">
            ...
            <span className="text-[12.2px] font-[400] text-[#000]">Low</span>
            <span className="text-[12.2px] font-[400] text-[#000]">Intermediate</span>
            <span className="text-[12.2px] font-[400] text-[#000]">High</span>
          </div>
        ...
        className="p-4 mb-6 rounded-lg ">
          <div className="flex items-center gap-3">
            <div className="text-sm">
              <p className="mb-2 font-medium text-black">Impressive score to succeed in crypto</p>
              <p className="leading-relaxed text-[#000]">In 2024, cryptos like Bitcoin and Solana gained over 150%. You can benefit too by staying informed, spotting undervalued projects early, and getting in before the next bull run begins.
              </p>
            </div>
          ...
          <div className="space-y-[15px] pb-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <h4 className="text-[12px] text-[#000] font-[500]">High</h4>
              </div>
            </div>
              <div className="flex items-center space-x-2">
              <img src={icons8} alt="" />
              ...
              <div>
                ...
                <h4 className="text-[12px] text-[#000] font-[500]">Fit for investing</h4>
              </div>
            </div>
              <div className="flex items-center space-x-2">
              <img src={icons6} alt="" />
              <div>
                ...
                <h4 className="text-[12px] text-[#000] font-[500]">Intermediate</h4>
              </div>
            </div>
          </div>
          <div>
    ...
    <div className="max-w-[548px]  pt-8 mx-auto text-black rounded-lg overflow-hidden">
          <h3 className="text-[16px] font-[700] text-black mb-3">Your readiness: <span className="text-[#3366F1]">{Math.round(readinessScore)}%</span></h3>
       ...
       >
          ...
          <div className="flex items-center justify-between mb-6 space-x-2">
            ...
            >
              ...
              <span className="text-[14px] text-black font-[700]">{mainGoal}</span>
            </div>
            <div className="space-y-[8px] py-[15px] flex flex-col items-center max-w-[273.94px] w-[100%] rounded-[4px]"
            style={{
              background:"#2525251A"
            ...
            >
              ...
              <span className="text-[14px] text-black font-[700]">{specialWish}</span>
            </div>
          </div>
        ...
        >
          <h3 className="text-[13px] font-[700] text-black">Your Financial Monthly Target:</h3>
           <span className=" text-[13px] font-[700] text-[#037FF9]">{goalIncome}</span>
        </div>
