...
//               className={`relative pr-4 flex items-center justify-between rounded-[8px] cursor-pointer transition-all duration-200 ${
...
//               <p className="w-[60%] text-[16px] text-black font-bold">{option.title}</p>
//             </div>
//           ))}
//         </div>
//       </div>
