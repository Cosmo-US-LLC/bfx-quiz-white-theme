    ...
    <div>
      ...
      >
        ...
        <div className=" !mt-[-22px] bg-[#037FF933] w-[100%] flex justify-center items-center rounded-[8px]">
          ...
          <h3 className=" text-black font-[500] text-[16px] py-[5px] ">
            35% Special Bonus expires in
            <span className="font-[700] text-[#037FF9] text-Manrope ">
              {" "}
            ...
            <div className="max-w-[618px] pt-5 px-4 pb-[1px] mx-auto bg-[#D9D9D980]">
              ...
              <div className="flex justify-between pl-3 items-center max-w-[506px] mx-auto w-[100%] bg-[#fff] mb-4">
                <div className="relative z-[9]">
                  ...
                  <div className="flex relative justify-around items-center border border-[#000] rounded-[8px] px-1 mr-1">
                    <button
                      ref={textRef}
                      className="h-[40px] px-1 text-black"
                      type="button"
                    >
                      upw8U2kbKCKzSZi
                    </button>
                    ...
                    {showPopup && (
                      <div className="fixed bottom-[8%] z-[99] shadow left-1/2 transform -translate-x-1/2 animate-in   zoom-in-95 duration-200">
                        <div className="bg-[#D9D9D980] text-black px-4 py-4 rounded-lg shadow-lg flex items-center gap-2 whitespace-nowrap">
                ...
                <div className="w-[30%] relative min-h-[194px]">
                  <img
                    src={result}
                    className="min-w-[250px] min-h-[194px] absolute top-[0%] right-[-65%] z-[1]"
                    alt=""
                  />
                </div>
              </div>
