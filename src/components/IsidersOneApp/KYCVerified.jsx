  ...
  const cardItems = [
    {
      ...
      description: (
        <p>
          BlockchainFX has been audited by Coinsult, a trusted firm from the
          Netherlands, confirming <br />
    ...
    },
    {
      ...
      description: (
        <p>
          CertiK, the world’s leading blockchain security firm, audited
          BlockchainFX and confirmed <br />
          it to be 100% secure.
        </p>
      ),
    },
